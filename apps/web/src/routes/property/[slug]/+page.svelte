...
<div class="container">
  <div class="imgGrid">
    <img src="{base}/houses/display/display-img-1.png" alt="" class="img1" />
    <img src="{base}/houses/display/display-img-2.png" alt="" class="img2" />
    <img src="{base}/houses/display/display-img-3.png" alt="" class="img3" />
  </div>

  <div class="info">
    <h3 class="name">Bedok Court</h3>
    <div class="likeContainer">
      <p class="address">123 Bedok North Ave 4, Singapore</p>
      <div class="like" />
    </div>

    <div class="tags">
      <div class="tag">HDB Flat</div>
    </div>
    ...
    <div class="details">
      <div class="leftDetails">
        <h4 class="price">S$2,550,000</h4>
        <p class="repayment">Est. Repayment S$2,180 / month</p>
      </div>
      ...
      <div class="rightDetails">
        <div class="detail">
          ...
          <p class="detailText">3 bed</p>
        </div>
        <div class="detail">
          <img src="{base}/icons/bathroom.svg" alt="" />
          <p class="detailText">2 bath</p>
        </div>
        <div class="detail">
          <img src="{base}/icons/area.svg" alt="" />
          <p class="detailText">2411 sqm</p>
        </div>
      </div>
    </div>
